...
theorem shakarachi_exercise_1_19a (z : ℂ) (hz : norm z = 1) (s : ℕ → ℂ)
    (h : s = (λ n => ∑ i ∈ (range n), i * z ^ i)) :
    ¬ ∃ y, Tendsto s atTop (𝓝 y) :=
sorry

theorem shakarachi_exercise_1_19b (z : ℂ) (hz : norm z = 1) (s : ℕ → ℂ)
    (h : s = (λ n => ∑ i ∈ (range n), i * z / i ^ 2)) :
    ∃ y, Tendsto s atTop (𝓝 y) :=
sorry

theorem shakarachi_exercise_1_19c (z : ℂ) (hz : norm z = 1) (hz2 : z ≠ 1) (s : ℕ → ℂ)
    (h : s = (λ n => ∑ i ∈ (range n), i * z / i)) :
