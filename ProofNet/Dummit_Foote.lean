...
theorem dummit_foote_exercise_3_2_16 (p : ℕ) (hp : Nat.Prime p) (a : ℕ) :
...
theorem dummit_foote_exercise_8_2_4 {R : Type*} [Ring R][NoZeroDivisors R]
...
theorem dummit_foote_exercise_8_3_4 {R : Type*} {n : ℤ} {r s : ℚ}
  (h : r^2 + s^2 = n) :
  ∃ a b : ℤ, a^2 + b^2 = n :=
sorry
